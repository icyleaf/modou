...
<body class="dev_site_page">
	...
	<div id="header_bar">
		<div id="header_logo">
			<a href="<?php echo url::base(); ?>console"><h1>豆瓣 API 测试控制台</h1></a>
		</div>
					...
					<ul>
						<li class="fb_menu">
							<div class="fb_menu_title">
								<a href="<?php echo url::base(); ?>console">豆瓣 API 测试控制器</a>
							</div>
						</li>
						<li class="fb_menu">
							<div class="fb_menu_title">
								<a href="http://www.douban.com/service/apidoc/">豆瓣API参考文档</a>
							</div>
						</li>
						<li class="fb_menu" id="fb_menu_community">
							<div class="fb_menu_title">
								<a href="http://www.douban.com/group/dbapi/">豆瓣API小组</a>
							</div>

						</li>
						<li class="fb_menu" id="fb_menu_resources">
							<div class="fb_menu_title">
								<a href="http://www.douban.com/service/apikey/">申请API Key</a>
							</div>
						</li>
						<li class="fb_menu">
							<div class="fb_menu_title">
								<a href="<?php echo URL::site('console/about'); ?>">关于</a>
							</div>
						</li>
					</ul>
				</div>
						...
						<h2>
							<span id="status_title">
								<div id="warning_text">用户必须登录验证后才能使用控制台。 
									<?php echo HTML::anchor('console/auth', '登录验证'); ?>
								</div>
							</span>
						</h2>
					</div>
					...
					<div class="form_bg clearfix">
						<div class="controls">
							...
							<div class="notice">
								...
								如果还再出现此问题，请<a href="mailto:icyleaf.cn@gmail.com">联系我</a>。
							</div>
						</div>
		...
		<?php elseif($action=='about'): ?>
			...
			<div class="content clearfix">
				<div id="tools_content" class="clearfix">
					...
					<p>
						由于封包还没有完成，现只提供用户，广播，书影音，豆邮和日记的不完全功能测试查询。
						其余的 API 会尽快添加进去 :)
					</p>
					
					<p>
						与此同时，不妨尝试一下我的另外一个豆瓣 API 应用：魔豆，
						豆瓣非官方移动版本，专注于手持设备以及移动设备。<br />
						网址：<a href="http://modou.us">http://modou.us</a>
					</p>
					...
					<p>
						Updated by icyleaf on 05/07/2010.
					</p>
				</div>
			</div>
...
$(document).ready(function(){
	...
	var method_file = base+'console/json/methods';
	var url_file = base+'console/json/urls';
